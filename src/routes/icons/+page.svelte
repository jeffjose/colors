		...
		<div class="flex-1 flex items-center justify-center p-8">
			...
			{:else}
				...
				<div class="text-center">
					<div
						class="w-24 h-24 mx-auto mb-4 rounded-xl bg-zinc-900 flex items-center justify-center"
					>
					...
					<p class="text-zinc-500 text-sm mb-2">No icon loaded</p>
					<p class="text-zinc-600 text-xs mb-4">
						Copy an SVG from Iconify, then paste it here
					</p>
					<button
						onclick={handlePaste}
						class="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium bg-zinc-800 text-zinc-200 hover:bg-zinc-700 transition-colors"
					>
						<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							<path
								stroke-linecap="round"
					...
					<div class="flex items-center justify-center gap-1.5 mt-2 text-zinc-600 text-xs">
						<span>or press</span>
						<kbd class="inline-flex items-center gap-0.5 px-1 py-0.5 rounded bg-zinc-800/80 border border-zinc-700 text-zinc-400 text-[10px] font-mono">
